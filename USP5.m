...
colormap(jet(128));
c = colorbar('southoutside','Ticks',[0,7.5,17.5,27.5,35],...
         'TickLabels',{'Very low','Low','Medium','High','Very High'});
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Mud and Wind velocity = 5 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(2);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Mud and Wind velocity = 15 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(3);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Mud and Wind velocity = 25 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(4);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Sand and Wind velocity = 5 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(5);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Sand and Wind velocity = 15 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(6);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Sand and Wind velocity = 25 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(7);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Gravel and Wind velocity = 5 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(8);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Gravel and Wind velocity = 15 knots'});
xlabel('r [m]');
ylabel('Z [m]');
figure(9);
CLIM = [0 35];
...
c.Label.String = 'Signal to Noise Ratio';
shading flat;
title({'SN ( r, z )'; 'For bottom type = Gravel and Wind velocity = 25 knots'});
xlabel('r [m]');
ylabel('Z [m]');
